<script setup>
import { image2, image3 } from '~/assets/images/caseStudies_images/link_images';
      ...
      <div class="solution-images">
        <div class="solution-one">
          <p class="solution-text">
            {{ $t("case_studies.link.solve-it.text") }}
          </p>
          <p class="solution-text--small">
            ...
            {{ $t("case_studies.link.solve-it.text_1") }}
          </p>
        ...
        <div class="solution-two">
          <p class="solution-text--small">
            ...
            {{ $t("case_studies.link.solve-it.text_2") }}
          </p>
...
.solution-image-wrapper--two .solution-image {
  max-width: 360px;
}
