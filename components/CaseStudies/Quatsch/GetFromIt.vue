...
import { quatschitemsEn, quatschitemsDe } from '~/data/quatschMansoryItems.js';
...
const items = computed(() => {
  return locale.value === 'en' ? quatschitemsEn : quatschitemsDe;
});
</script>
...
<template>
  <div class="improvements">
    ...
    <div class="improvements-masonary">
      <masonry-wall
        class="improvements-masonary-wall"
        :items="items"
        :ssr-columns="2"
        :column-width="220"
        :gap="20"
