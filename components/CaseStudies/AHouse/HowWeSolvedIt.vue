...
import {
  image1,
  image4,
} from '~/assets/images/caseStudies_images/ahouse_images';
  ...
  <div class="solution">
    ...
    <div class="solution-content">
      <div class="solution-images">
        <div class="solution-one">
          <p class="solution-text--small">
            ...
            {{ $t("case_studies.a-house.solve-it.text") }}
          </p>
        ...
        <div class="solution-two">
          <p class="solution-text--small">
            ...
            {{ $t("case_studies.a-house.solve-it.text_1") }}
          </p>
      ...
      <div class="how-we-did-it">
        <p class="title">
          {{ $t("case_studies.a-house.solve-it.text_6") }}
        </p>
        <div class="ticked-text-container">
          <CommonTickedText
            :text="$t('case_studies.a-house.solve-it.text_2')"
          />
          <CommonTickedText
            :text="$t('case_studies.a-house.solve-it.text_3')"
          />
          <CommonTickedText
            :text="$t('case_studies.a-house.solve-it.text_4')"
          />
          <CommonTickedText
            :text="$t('case_studies.a-house.solve-it.text_5')"
          />
        </div>
      </div>
    </div>
