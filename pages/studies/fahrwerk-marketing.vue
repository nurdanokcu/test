...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.fahrwerkMarketing.title'));
...
const ids = [
  'fahrwerkDigitalApproach',
  'fahrwerkDigitalResults',
  'fahrwerkDigitalFeedback',
];
</script>
...
<template>
  <div>
    ...
    <main class="main">
      <div
        :id="$t('case_studies.fahrwerkdigital.heading.scrollPathId')"
        class="main-hidden"
      ></div>
      ...
      <CaseStudiesFahrwerkDigitalHowWeDidIt
        ...
        :id-for-hidden="ids[0]"
      />
      <CaseStudiesFahrwerkDigitalHowWeSolvedIt
        v-intersection-observer="[
        ...
        :id-for-hidden="ids[1]"
      />
      <CaseStudiesFahrwerkDigitalGetFromIt
        v-intersection-observer="[
