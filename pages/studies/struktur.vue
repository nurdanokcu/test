...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.struktur.title'));
const description = computed(() => t('seo.caseStudies.struktur.description'));
...
const ids = ['strukturApproach', 'strukturResults', 'strukturFeedback'];
</script>
...
<template>
  <div>
    ...
    <CaseStudiesStrukturHeader />
    <main class="main">
      <div
        :id="$t('case_studies.struktur.heading.scrollPathId')"
        class="main-hidden"
      ></div>
      ...
      <CaseStudiesStrukturHowWeDidIt
        ...
        :id-for-hidden="ids[0]"
      />
      <CaseStudiesStrukturHowWeSolvedIt
        v-intersection-observer="[
