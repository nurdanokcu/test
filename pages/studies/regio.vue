...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.regio.title'));
const description = computed(() => t('seo.caseStudies.regio.description'));
...
const ids = ['regioApproach', 'regioResults', 'regioFeedback'];
</script>
...
<template>
  <div>
    ...
    <CaseStudiesRegioHeader />
    <main class="main">
      <div
        :id="$t('case_studies.regio.heading.scrollPathId')"
        class="main-hidden"
      ></div>
