...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.cityCampus.title'));
const description = computed(() => t('seo.caseStudies.cityCampus.description'));
...
const ids = ['cityCampusApproach', 'cityCampusResults', 'cityCampusFeedback'];
</script>
...
<template>
  <div>
    ...
    <CaseStudiesCityCampusHeader />
    <main class="main">
      <div
        :id="$t('case_studies.citycampus.heading.scrollPathId')"
        class="main-hidden"
      ></div>
      ...
      <CaseStudiesCityCampusHowWeDidIt
        ...
        :id-for-hidden="ids[0]"
      />
      <CaseStudiesCityCampusHowWeSolvedIt
        v-intersection-observer="[
        ...
        :id-for-hidden="ids[1]"
      />
      <CaseStudiesCityCampusGetFromIt
        v-intersection-observer="[
