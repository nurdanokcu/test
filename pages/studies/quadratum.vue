...
const ids = ['quadratumApproach', 'quadratumResults', 'quadratumFeedback'];
</script>
...
<template>
  <div>
    ...
    <main class="main">
      <div
        :id="$t('case_studies.quadratum.heading.scrollPathId')"
        class="main-hidden"
      ></div>
      ...
      <CaseStudiesQuadratumHowWeDidIt
        ...
        :id-for-hidden="ids[0]"
      />
      <CaseStudiesQuadratumHowWeSolvedIt
        v-intersection-observer="[
