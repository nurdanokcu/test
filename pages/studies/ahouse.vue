...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.aHouse.title'));
const description = computed(() => t('seo.caseStudies.aHouse.description'));
...
const ids = ['ahouseApproach', 'ahouseResults', 'ahouseFeedback'];
</script>
...
<template>
  <div>
    ...
    <CaseStudiesAHouseHeader />
    <main class="main">
      <div
        :id="$t('case_studies.a-house.heading.scrollPathId')"
        class="main-hidden"
      ></div>
      ...
      <CaseStudiesAHouseHowWeDidIt
        ...
        :id-for-hidden="ids[0]"
      />
      <CaseStudiesAHouseHowWeSolvedIt
        v-intersection-observer="[
