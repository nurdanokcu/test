...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.lilienthal.title'));
const description = computed(() => t('seo.caseStudies.lilienthal.description'));
...
const ids = ['lilienthalApproach', 'lilienthalResults', 'lilienthalFeedback'];
</script>
...
<template>
  <div>
    ...
    <div class="main">
      <div
        :id="$t('case_studies.lilienthal.heading.scrollPathId')"
        class="main-hidden"
      ></div>
      ...
      <CaseStudiesLilienthalHowWeDidIt
        ...
        :id-for-hidden="ids[0]"
      />
      <CaseStudiesLilienthalHowWeSolvedIt
        v-intersection-observer="[
        ...
        :id-for-hidden="ids[1]"
      />
      <CaseStudiesLilienthalGetFromIt
        v-intersection-observer="[
