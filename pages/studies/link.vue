...
const { t } = useI18n();
const title = computed(() => t('seo.caseStudies.link.title'));
const description = computed(() => t('seo.caseStudies.link.description'));
useHead({
  title: title.value,
  meta: [
    {
...
const ids = ['linkApproach', 'linkResults', 'linkFeedback'];
</script>

<template>
  <div>
    <CaseStudiesLinkHeader />
    <main class="main">
      <div
        :id="$t('case_studies.link.heading.scrollPathId')"
        class="main-hidden"
      ></div>
